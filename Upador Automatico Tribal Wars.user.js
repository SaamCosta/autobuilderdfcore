...
//*************************** QUEST ***************************//
    // Construção Edificio Principal 1
    Sequência_Construção.push("main_buildlink_main_1");
    // Construção Estatua 1
    Sequência_Construção.push("main_buildlink_statue_1");
    // Construção Praça de Reunião 1
    Sequência_Construção.push("main_buildlink_place_1");
    // Construção Argila 1
    ...
    // Construção Armazém 1
    Sequência_Construção.push("main_buildlink_storage_1");
